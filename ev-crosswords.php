...
if ( ! class_exists('AIAPI')) {
    include_once dirname( __FILE__ ) . '/classes/AIAPI.php';
}
if ( ! class_exists('CreatoriveCwMaker')) {
    include_once dirname( __FILE__ ) . '/classes/CreatoriveCwMaker.php';
}
if ( ! class_exists('EvCwPluginLauncher')) {
